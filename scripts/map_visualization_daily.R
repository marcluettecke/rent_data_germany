...
economics_data <- jsonlite::fromJSON(txt='./data/combined_daily.json', simplifyDataFrame = TRUE)


cities = c("Berlin", "Hamburg", "Hannover", "Muenchen", "Koeln", "Frankfurt",
           "Stuttgart", "Duesseldorf", "Dortmund", "Essen",
           "Leipzig", "Bremen", "Dresden", "Nuernberg")
...
rent_all <- feather::read_feather('./data/rent_data_daily.feather') %>%
...
rent_all$city[6] = "Duesseldorf"
rent_all$city[10] = "Hannover"
rent_all$city[12] = "Muenchen"
#merge the two datasets to have one master df
df_complete <- merge(rent_all, econ_df, by.x = "city", by.y="cities")
...
CC_2_codes = c('11000','04011','05913' ,'14612','05111', '05113','06412','02000', '03241', '05315','14729',
               '09162','09564', '08111' )
...
label_crime <- sprintf(
    "<strong>Crime rate in </strong>%s:<br/>%g %%",
